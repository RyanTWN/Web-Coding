...
async function initializeDatabaseSchema(pool, AUTH_SECRET) {
  ...
  `);
  await pool.query(`
    CREATE TABLE IF NOT EXISTS chinese_daily_progress (
      seat_no VARCHAR(32) NOT NULL,
      learning_date DATE NOT NULL,
      attempt_no SMALLINT UNSIGNED NOT NULL DEFAULT 1,
      publisher VARCHAR(16) NOT NULL,
      chapter_name VARCHAR(255) NOT NULL,
      curriculum_version VARCHAR(32) NOT NULL DEFAULT '115-G6-CHINESE-1',
      questions_json LONGTEXT NOT NULL,
      answers_json LONGTEXT NOT NULL,
      wrong_questions_json LONGTEXT NOT NULL,
      current_question_index TINYINT UNSIGNED NOT NULL DEFAULT 0,
      ...
      completed_at TIMESTAMP NULL,
      PRIMARY KEY (seat_no, learning_date, attempt_no),
      KEY ix_chinese_completed (seat_no, completed, learning_date),
      KEY ix_chinese_daily_attempt (seat_no, learning_date, completed, attempt_no)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
  `);
  await pool.query(`
    CREATE TABLE IF NOT EXISTS chinese_wrong_questions (
      seat_no VARCHAR(32) NOT NULL,
      question_id VARCHAR(100) NOT NULL,
      question_json LONGTEXT NOT NULL,
      wrong_count INT UNSIGNED NOT NULL DEFAULT 1,
      ...
      mastered_at TIMESTAMP NULL,
      PRIMARY KEY (seat_no, question_id),
      KEY ix_chinese_review (seat_no, mastered, last_wrong_at)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
  `);
  await pool.query(`
    CREATE TABLE IF NOT EXISTS student_idiom_stars (
      seat_no VARCHAR(32) NOT NULL,
      idiom_id INT UNSIGNED NOT NULL,
      created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
      PRIMARY KEY (seat_no, idiom_id),
      KEY ix_idiom_stars_seat (seat_no)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
  `);
  await pool.query(`
    CREATE TABLE IF NOT EXISTS student_idiom_progress (
      seat_no VARCHAR(32) NOT NULL,
      last_idiom_id INT UNSIGNED NOT NULL DEFAULT 1,
      daily_history_json LONGTEXT NULL,
      updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
      PRIMARY KEY (seat_no)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
  `);
